...
final class MyCertifyEmptyCell: UICollectionViewCell {
    
    static let identifier = "MyCertifyEmptyCell"
    
    private let emptyStateView = EmptyStateView(mainTitle: "인증한 챌린지가 없습니다", subTitle: "함께 인증하는 금융 챌린지를\n진행해보세요")
